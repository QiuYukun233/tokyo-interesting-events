...
5. **餐饮、影视、剧本杀、手作、剧场六个品类目前完全没有覆盖。** 已做过一轮
   调研（`docs/信息获取管道设计.md` 第二轮）：HotPepper（餐厅）、CoRich（音乐剧/
   小剧场）、mdms-mania.com（剧本杀）三条路径干净可接，尚未实现；映画.com（电影）
   与 Craftie（手作工坊）明确被利用规约挡住，不接；餐厅定期菜单和拼豆没有找到
   可规模化的入口。
