...
export const SOURCES = [
  {
    name: 'My TOKYO',
    url: 'https://www.my.metro.tokyo.lg.jp/event/?sort=near-end&page=1',
    urls: [1, 2, 3, 4, 5].map((page) => `https://www.my.metro.tokyo.lg.jp/event/?sort=near-end&page=${page}`),
    origin: 'https://www.my.metro.tokyo.lg.jp',
    parse: parseMyTokyo,
  },
