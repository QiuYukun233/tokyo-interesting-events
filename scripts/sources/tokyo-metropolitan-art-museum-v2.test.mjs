...
import { parseTokyoMetropolitanArtMuseum } from './tokyo-metropolitan-art-museum-v2.mjs';
...
test('keeps only current/upcoming museum cards with dates, category, and canonical link', () => {
