...
import { collectShibuyaKeizaiShopChanges, SHIBUYA_KEIZAI_HOME_URL } from './sources/shibuya-keizai-shop-changes.mjs';
import { collectIkebukuroKeizaiShopChanges, IKEBUKURO_KEIZAI_HOME_URL } from './sources/ikebukuro-keizai-shop-changes.mjs';
