...
import { tagPrompt, parseTagResponse, tokyoDate } from './tagging.mjs';

test('tokyoDate uses Tokyo calendar date even when the runner is UTC', () => {
  const utcAfternoon = new Date('2026-08-28T15:30:00Z');
  assert.equal(tokyoDate(utcAfternoon), '2026-08-29');
});
