...
const CANDIDATE_COLUMNS = [
  ...
  'popularity', 'ongoing', 'reasons', 'signals',
];
...
const ADDED_COLUMNS = [
  ['ongoing', 'INTEGER NOT NULL DEFAULT 0'],
  // Source-reported interest count (CoRich: 観たい+観てきた). NULL = the source
  // has no such signal; 0 = the source reported zero. Keep those distinct.
  ['popularity', 'INTEGER'],
];
