 ...
 */
const NOT_A_DESTINATION_CODES = new Set(['hard:submission_call', 'hard:bulletin', 'hard:on_sale_announcement']);

const notADestination = {
  name: 'not_a_destination',
  state: 'rejected',
  reason: '内容本身不是可去处（征稿/简报/开售公告），与是否有趣无关',
...
export const RULES = [tradeOnly, notADestination];
